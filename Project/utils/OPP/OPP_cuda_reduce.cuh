...
namespace OPP 
{
    // reduction : op�ration associative mais non commutative
    // -> aucune permutation autoris� !
    // il faut donc respecter l'ordre des op�rations ...
    // NB : possible d'�crire une version "commutative" plus performante
    namespace CUDA 
    {
        namespace REDUCE 
        {
